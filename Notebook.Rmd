...
ggplot(df, aes(x = date, y = fcst), scale) + 
  geom_line() + 
  scale_x_continuous(breaks = seq(as.Date("2023-06-01"), as.Date("2025-05-01"), by = "month"), labels = seq(as.Date("2023-06-01"), as.Date("2025-05-01"), by = "month")) +
